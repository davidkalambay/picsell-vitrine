...
- [x] **10. Mode Éco-responsable** : Détecter la batterie faible ou le mode économie d'énergie pour réduire les calculs d'ombres et le framerate de fond. *(Testé & Implémenté sur `feat/eco-mode-battery-detection`)*
