            ...
            >
                <div>
                    ...
                    <div className="space-y-7">
                        ...
                        {/* Option 20: Accélération 100% GPU (Winston's Idea 02) */}
                        <div className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.03] border border-white/10">
                            <div>
                                <div className="flex items-center gap-1.5">
                                ...
                                <p className="text-xs text-slate-400">Isolation des couches 3D, zéro Repaint et force3D matériel</p>
                            </div>
                            <input
                                type="checkbox"
                        ...
                        {/* Option 21: GSAP MatchMedia Responsive (Winston's Idea 03) */}
                        <div className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.03] border border-white/10">
                            <div>
                                <div className="flex items-center gap-1.5">
                                ...
                                <p className="text-xs text-slate-400">Adaptation des timelines et scrubbing Desktop / Tablette / Mobile</p>
                            </div>
                            <input
                                type="checkbox"
                        ...
                        {/* Option 22: Respect prefers-reduced-motion (Winston's Idea 04) */}
                        <div className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.03] border border-white/10">
                            <div>
                                <div className="flex items-center gap-1.5">
                                ...
                                <p className="text-xs text-slate-400">Désactivation des rotations et cinétiques intenses (système & manuel)</p>
                            </div>
                            <input
                                type="checkbox"
